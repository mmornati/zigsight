...
def test_manifest_exists() -> None:
    ...
    manifest_path = Path(__file__).parent.parent / "custom_components" / "zigsight" / "manifest.json"
...
def test_manifest_has_required_fields() -> None:
    ...
    assert isinstance(manifest["version"], str), "manifest.json version should be a string"
